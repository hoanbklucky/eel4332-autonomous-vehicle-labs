...
Use the Lab 3 bicycle simulator plus the tracking controller. If the instructor provides a pinned F1TENTH environment, it may be used as an optional second experiment.
