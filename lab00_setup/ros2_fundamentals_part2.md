...
[Part 1: Graph and Communication](ros2_fundamentals_part1.md) | [Lab 00 setup](README.md)
...
**Command breakdown:** `ln -s` creates a symbolic link inside the workspace. The package remains in the course repository, while colcon sees it under the workspace's required `src/` directory.
...
Return to [Lab 00 setup](README.md), then complete the [Gazebo Fundamentals Practice](gazebo_fundamentals.md).
